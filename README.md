...
| `cuda-12_9` | 0.24.0 | 2.9.1 | 12.9.1 | 58 | Full coverage + SM75/SM103 |
...
| **SM80 (Ampere DC)** | AVX2 | `torchvision-python313-cuda12_8-sm80-avx2` | A100/A30 + broad CPU compatibility |
| | AVX-512 | `torchvision-python313-cuda12_8-sm80-avx512` | A100/A30 + general workloads |
| | AVX-512 BF16 | `torchvision-python313-cuda12_8-sm80-avx512bf16` | A100/A30 + BF16 training |
| | AVX-512 VNNI | `torchvision-python313-cuda12_8-sm80-avx512vnni` | A100/A30 + INT8 inference |
| | ARMv8.2 | `torchvision-python313-cuda12_8-sm80-armv8_2` | A100/A30 + ARM Graviton2 |
| | ARMv9 | `torchvision-python313-cuda12_8-sm80-armv9` | A100/A30 + ARM Grace |
| **SM86 (Ampere)** | AVX2 | `torchvision-python313-cuda12_8-sm86-avx2` | RTX 3090/A40 + broad CPU compatibility |
| | AVX-512 | `torchvision-python313-cuda12_8-sm86-avx512` | RTX 3090/A40 + general workloads |
| | AVX-512 BF16 | `torchvision-python313-cuda12_8-sm86-avx512bf16` | RTX 3090/A40 + BF16 training |
| | AVX-512 VNNI | `torchvision-python313-cuda12_8-sm86-avx512vnni` | RTX 3090/A40 + INT8 inference |
| | ARMv8.2 | `torchvision-python313-cuda12_8-sm86-armv8_2` | RTX 3090/A40 + ARM Graviton2 |
| | ARMv9 | `torchvision-python313-cuda12_8-sm86-armv9` | RTX 3090/A40 + ARM Grace |
| **SM89 (Ada)** | AVX2 | `torchvision-python313-cuda12_8-sm89-avx2` | RTX 4090/L40 + broad CPU compatibility |
| | AVX-512 | `torchvision-python313-cuda12_8-sm89-avx512` | RTX 4090/L40 + general workloads |
| | AVX-512 BF16 | `torchvision-python313-cuda12_8-sm89-avx512bf16` | RTX 4090/L40 + BF16 training |
| | AVX-512 VNNI | `torchvision-python313-cuda12_8-sm89-avx512vnni` | RTX 4090/L40 + INT8 inference |
| | ARMv8.2 | `torchvision-python313-cuda12_8-sm89-armv8_2` | RTX 4090/L40 + ARM Graviton2 |
| | ARMv9 | `torchvision-python313-cuda12_8-sm89-armv9` | RTX 4090/L40 + ARM Grace |
| **SM90 (Hopper)** | AVX2 | `torchvision-python313-cuda12_8-sm90-avx2` | H100/L40S + broad CPU compatibility |
| | AVX-512 | `torchvision-python313-cuda12_8-sm90-avx512` | H100/L40S + general workloads |
| | AVX-512 BF16 | `torchvision-python313-cuda12_8-sm90-avx512bf16` | H100/L40S + BF16 training |
| | AVX-512 VNNI | `torchvision-python313-cuda12_8-sm90-avx512vnni` | H100/L40S + INT8 inference |
| | ARMv8.2 | `torchvision-python313-cuda12_8-sm90-armv8_2` | H100/L40S + ARM Graviton2 |
| | ARMv9 | `torchvision-python313-cuda12_8-sm90-armv9` | H100/L40S + ARM Grace |
| **SM100 (Blackwell DC)** | AVX2 | `torchvision-python313-cuda12_8-sm100-avx2` | B100/B200 + broad CPU compatibility |
| | AVX-512 | `torchvision-python313-cuda12_8-sm100-avx512` | B100/B200 + general workloads |
| | AVX-512 BF16 | `torchvision-python313-cuda12_8-sm100-avx512bf16` | B100/B200 + BF16 training |
| | AVX-512 VNNI | `torchvision-python313-cuda12_8-sm100-avx512vnni` | B100/B200 + INT8 inference |
| | ARMv8.2 | `torchvision-python313-cuda12_8-sm100-armv8_2` | B100/B200 + ARM Graviton2 |
| | ARMv9 | `torchvision-python313-cuda12_8-sm100-armv9` | B100/B200 + ARM Grace |
| **SM61 (Pascal)** | AVX | `torchvision-python313-cuda12_8-sm61-avx` | GTX 1070/1080 Ti + legacy AVX CPUs |
| | AVX2 | `torchvision-python313-cuda12_8-sm61-avx2` | GTX 1070/1080 Ti + modern CPUs |
| **SM120 (Blackwell)** | AVX2 | `torchvision-python313-cuda12_8-sm120-avx2` | RTX 5090 + broad CPU compatibility |
| | AVX-512 | `torchvision-python313-cuda12_8-sm120-avx512` | RTX 5090 + general workloads |
| | AVX-512 BF16 | `torchvision-python313-cuda12_8-sm120-avx512bf16` | RTX 5090 + BF16 training |
...
|--------|-------------|---------|------|---------------|----------|
| `cuda-12_9` | 0.24.0 | 2.9.1 | 12.9.1 | SM61–SM120 + SM75/SM103 | 58 (full coverage) |
| `cuda-13_0` | TBD | 2.10 | 13.0 | SM75–SM121 + ARM | 59 |

```bash
# TorchVision 0.24.0 + PyTorch 2.9.1 + CUDA 12.9.1 (recommended for latest features)
git checkout cuda-12_9 && flox build torchvision-python313-cuda12_9-sm90-avx512
...
# The result will be in ./result-torchvision-python313-cuda12_8-sm90-avx512/
ls -lh result-torchvision-python313-cuda12_8-sm90-avx512/

# Test the build
./result-torchvision-python313-cuda12_8-sm90-avx512/bin/python -c "
...
(nixpkgs_pinned.python3Packages.torchvision.override {
  ...
  pname = "torchvision-python313-cuda12_8-sm89-avx512";
  ...
})
```
...
1. **Nixpkgs Pin**: Each variant pins nixpkgs to commit `fe5e41d` for reproducible PyTorch 2.8.0 + TorchVision 0.23.0
...
flox publish -o <your-org> torchvision-python313-cuda12_8-sm90-avx512
flox publish -o <your-org> torchvision-python313-cuda12_8-sm86-avx2
flox publish -o <your-org> torchvision-python313-cpu-avx2

# Users install with:
flox install <your-org>/torchvision-python313-cuda12_8-sm90-avx512
```
...
```nix
# .flox/pkgs/torchvision-python313-cuda12_8-sm89-avx512.nix
{ pkgs ? import <nixpkgs> {} }:

let
  # Pin nixpkgs for reproducible PyTorch 2.8.0 + TorchVision 0.23.0
