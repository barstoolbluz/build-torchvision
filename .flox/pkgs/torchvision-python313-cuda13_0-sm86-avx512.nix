# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Ampere (SM86: RTX 30 series) + AVX-512
# Package name: torchvision-python313-cuda13_0-sm86-avx512
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm86-avx512";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm86-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA RTX 30 series (SM86, Ampere) + AVX-512 with PyTorch 2.10.0";
      longDescription = ''
