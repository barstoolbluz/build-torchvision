# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Rubin (Future) (SM120) + ARMv9
# Package name: torchvision-python313-cuda13_1-sm120-armv9
#
...
let
  ...
  # GPU target: SM120 (Blackwell Thor/NVIDIA DRIVE - automotive/edge computing)
  gpuArchSM = "12.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm120-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm120-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Rubin (Future): SM120)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA Rubin (Future) (SM120) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Blackwell Thor/DRIVE architecture (SM120)
