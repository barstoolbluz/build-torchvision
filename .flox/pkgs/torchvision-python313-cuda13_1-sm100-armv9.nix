# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA B100 (Blackwell) (SM100) + ARMv9
# Package name: torchvision-python313-cuda13_1-sm100-armv9
#
...
let
  ...
  # GPU target: SM100 (Blackwell Thor/NVIDIA DRIVE - automotive/edge computing)
  gpuArchSM = "10.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm100-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm100-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (B100 (Blackwell): SM100)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA B100 (Blackwell) (SM100) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Blackwell Thor/DRIVE architecture (SM100)
        - CPU: ARMv9-A with SVE and SVE2 vector extensions
        ...
        - CPU: ARM Neoverse V2, Cortex-X3+, next-gen automotive ARM SoCs
