# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Hopper (SM90: H100/H200) + AVX-512
# Package name: torchvision-python313-cuda13_1-sm90-avx512
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm90-avx512";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm90-avx512";
