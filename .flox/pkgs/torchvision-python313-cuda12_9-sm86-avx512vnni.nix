# TorchVision optimized for NVIDIA Ampere RTX 30-series (SM86) + AVX-512 VNNI
# Package name: torchvision-python313-cuda12_9-sm86-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm86-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Ampere RTX 30-series (SM86) + AVX-512 VNNI";
