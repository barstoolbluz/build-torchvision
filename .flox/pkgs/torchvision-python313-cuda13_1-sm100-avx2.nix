# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Blackwell Datacenter (SM100: B100/B200) + AVX2
# Package name: torchvision-python313-cuda13_1-sm100-avx2
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm100-avx2";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm100-avx2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA B100/B200 Datacenter (SM100, Blackwell) + AVX2 with PyTorch 2.10.0";
      longDescription = ''
