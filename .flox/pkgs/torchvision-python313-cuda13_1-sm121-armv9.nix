# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA DGX Spark (SM121) + ARMv9
# Package name: torchvision-python313-cuda13_1-sm121-armv9
#
...
let
  ...
  # CPU optimization: ARMv9-A with SVE2
  cpuFlags = [
    "-march=armv9-a+sve2"
  ];
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm121-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm121-armv9";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        - CPU: ARMv9-A with SVE2 vector extensions
        ...
        - CPU: ARM Neoverse V2, Cortex-X3+, Grace CPU
