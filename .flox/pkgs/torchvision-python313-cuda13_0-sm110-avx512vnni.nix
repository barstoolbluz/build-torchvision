# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA DRIVE Thor (SM110) + AVX-512 VNNI
# Package name: torchvision-python313-cuda13_0-sm110-avx512vnni
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm110-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm110-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA DRIVE Thor (SM110) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
