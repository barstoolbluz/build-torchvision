# TorchVision optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + AVX2
# Package name: torchvision-python313-cuda12_9-sm89-avx2
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm89-avx2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + AVX2";
