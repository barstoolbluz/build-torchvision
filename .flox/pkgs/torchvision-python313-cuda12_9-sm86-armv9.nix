# TorchVision optimized for NVIDIA Ampere RTX 30-series (SM86) + ARMv9
# Package name: torchvision-python313-cuda12_9-sm86-armv9
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm86-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Ampere RTX 30-series (SM86) + ARMv9";
