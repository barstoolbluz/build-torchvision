# TorchVision optimized for NVIDIA Turing T4/RTX 2080 Ti (SM75) + ARMv8.2
# Package name: torchvision-python313-cuda12_9-sm75-armv8_2
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm75-armv8_2";
