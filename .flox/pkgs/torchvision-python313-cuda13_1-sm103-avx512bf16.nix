# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA B300 Datacenter (SM103) + AVX-512 BF16
# Package name: torchvision-python313-cuda13_1-sm103-avx512bf16
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm103-avx512bf16";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm103-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA B300 Datacenter (SM103) + AVX-512 BF16 with PyTorch 2.10.0";
      longDescription = ''
