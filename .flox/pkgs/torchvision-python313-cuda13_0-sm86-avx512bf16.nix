# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Ampere (SM86: RTX 30 series) + AVX-512 BF16
# Package name: torchvision-python313-cuda13_0-sm86-avx512bf16
#
...
let
  ...
  # GPU target: SM86 (Ampere - RTX 30 series)
  gpuArchSM = "8.6";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm86-avx512bf16";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm86-avx512bf16";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Ampere: RTX 30 series/A5000/A40)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA RTX 30 series (SM86, Ampere) + AVX-512 BF16 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Ampere architecture (SM86) - RTX 3090/3080/3070/A5000/A40
        - CPU: x86-64 with AVX-512 BF16 instruction set
        - CUDA: 13.0 with compute capability 8.6
        - PyTorch: 2.10.0 (with all CUDA 13.0 compatibility fixes)
        - MAGMA: Enabled (patched for CUDA 13.0)
        - Python: 3.13

        Hardware requirements:
        - GPU: RTX 3090, RTX 3080, RTX 3070, A5000, A40, or other SM86 GPUs
