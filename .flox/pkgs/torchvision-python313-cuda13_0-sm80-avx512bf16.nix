# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Ampere Datacenter (SM80: A100/A30) + AVX-512 BF16
# Package name: torchvision-python313-cuda13_0-sm80-avx512bf16
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm80-avx512bf16";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm80-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA A100/A30 (SM80, Ampere DC) + AVX-512 BF16 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Ampere Datacenter architecture (SM80) - A100/A30
        - CPU: x86-64 with AVX-512 BF16 instruction set
        - CUDA: 13.0 with compute capability 8.0
