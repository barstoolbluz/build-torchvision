# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA B300 Datacenter (SM103) + AVX-512 VNNI
# Package name: torchvision-python313-cuda13_0-sm103-avx512vnni
#
...
let
  ...
  # GPU target: SM103 (B300 Datacenter)
  gpuArchSM = "10.3";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm103-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm103-avx512vnni";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (B300 Datacenter)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA B300 Datacenter (SM103) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA B300 Datacenter architecture (SM103)
        ...
        - GPU: NVIDIA B300 or other SM103 GPUs
