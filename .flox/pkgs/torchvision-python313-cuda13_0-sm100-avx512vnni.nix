# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Blackwell Datacenter (SM100: B100/B200) + AVX-512 VNNI
# Package name: torchvision-python313-cuda13_0-sm100-avx512vnni
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm100-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm100-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA B100/B200 Datacenter (SM100, Blackwell) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
