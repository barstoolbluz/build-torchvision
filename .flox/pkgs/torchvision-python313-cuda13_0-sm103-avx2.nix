# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA B300 Datacenter (SM103) + AVX2
# Package name: torchvision-python313-cuda13_0-sm103-avx2
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm103-avx2";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm103-avx2";
