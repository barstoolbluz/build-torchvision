# TorchVision optimized for NVIDIA Ampere RTX 30-series (SM86) + AVX-512 BF16
# Package name: torchvision-python313-cuda12_9-sm86-avx512bf16
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm86-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Ampere RTX 30-series (SM86) + AVX-512 BF16";
