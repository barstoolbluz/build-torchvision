...
# Package name: torchvision-python313-cuda12_8-sm103-avx512
...
in
  (torchvision_0_23_0.override {
    ...
    pname = "torchvision-python313-cuda12_8-sm103-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision 0.23.0 for NVIDIA Blackwell B300 (SM103) + AVX-512";
      longDescription = ''
