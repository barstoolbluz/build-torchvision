# TorchVision optimized for NVIDIA Ampere RTX 3090/A40 (SM86) + AVX2
# Package name: torchvision-python313-cuda12_8-sm86-avx2
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_8-sm86-avx2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Ampere RTX 3090/A40 (SM86) + AVX2";
