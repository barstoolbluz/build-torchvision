# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA DRIVE Thor (SM110) + AVX-512
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm110-avx512";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA DRIVE Thor (SM110) + AVX-512 with PyTorch 2.10.0";
      longDescription = ''
