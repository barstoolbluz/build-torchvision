# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Ada Lovelace (SM89: RTX 40 series) + AVX-512
# Package name: torchvision-python313-cuda13_0-sm89-avx512
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm89-avx512";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm89-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA RTX 40 series (SM89, Ada Lovelace) + AVX-512 with PyTorch 2.10.0";
      longDescription = ''
