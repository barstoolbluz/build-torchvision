# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA RTX 3090/A40 (SM86) + ARMv9
# Package name: torchvision-python313-cuda13_0-sm86-armv9
#
...
let
  ...
  # GPU target: SM86 (Blackwell Thor/NVIDIA DRIVE - automotive/edge computing)
  gpuArchSM = "8.6";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm86-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm86-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (DRIVE Thor: SM86)"
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        - GPU: NVIDIA Blackwell Thor/DRIVE architecture (SM86)
