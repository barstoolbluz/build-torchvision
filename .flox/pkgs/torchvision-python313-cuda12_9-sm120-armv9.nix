# TorchVision optimized for NVIDIA Next-Gen (SM120) + ARMv9
# Package name: torchvision-python313-cuda12_9-sm120-armv9
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm120-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Next-Gen (SM120) + ARMv9";
