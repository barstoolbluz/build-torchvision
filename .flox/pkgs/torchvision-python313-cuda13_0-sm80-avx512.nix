# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Ampere Datacenter (SM80: A100/A30) + AVX-512
# Package name: torchvision-python313-cuda13_0-sm80-avx512
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm80-avx512";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm80-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA A100/A30 (SM80, Ampere DC) + AVX-512 with PyTorch 2.10.0";
      longDescription = ''
