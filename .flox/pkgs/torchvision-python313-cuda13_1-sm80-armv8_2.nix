# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA A100 (Ampere) (SM80) + ARMv8.2
# Package name: torchvision-python313-cuda13_1-sm80-armv8_2
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm80-armv8_2";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm80-armv8_2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA A100 (Ampere) (SM80) + ARMv8.2 with PyTorch 2.10.0";
      longDescription = ''
