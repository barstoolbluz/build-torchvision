# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Hopper (SM90: H100/H200) + AVX-512 BF16
# Package name: torchvision-python313-cuda13_0-sm90-avx512bf16
#
...
let
  ...
  # GPU target: SM90 (Hopper - H100/H200)
  gpuArchSM = "9.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm90-avx512bf16";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm90-avx512bf16";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Hopper: H100/H200)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA H100/H200 (SM90, Hopper) + AVX-512 BF16 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Hopper architecture (SM90) - H100/H200/L40S
