# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA B200 (Blackwell) (SM103) + ARMv9
# Package name: torchvision-python313-cuda13_1-sm103-armv9
#
...
let
  ...
  # GPU target: SM103 (Blackwell Thor/NVIDIA DRIVE - automotive/edge computing)
  gpuArchSM = "10.3";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm103-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm103-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (B200 (Blackwell): SM103)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA B200 (Blackwell) (SM103) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Blackwell Thor/DRIVE architecture (SM103)
