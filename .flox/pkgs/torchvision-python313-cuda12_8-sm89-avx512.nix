# TorchVision optimized for NVIDIA Ada Lovelace RTX 4090/L40 (SM89) + AVX-512
# Package name: torchvision-python313-cuda12_8-sm89-avx512
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Ada Lovelace RTX 4090/L40 (SM89) + AVX-512";
