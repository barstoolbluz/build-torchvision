# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Ada Lovelace (SM89: RTX 40 series) + AVX-512 BF16
# Package name: torchvision-python313-cuda13_0-sm89-avx512bf16
#
...
let
  ...
  # GPU target: SM89 (Ada Lovelace - RTX 40 series)
  gpuArchSM = "8.9";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm89-avx512bf16";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm89-avx512bf16";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Ada Lovelace: RTX 40 series)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA RTX 40 series (SM89, Ada Lovelace) + AVX-512 BF16 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Ada Lovelace architecture (SM89) - RTX 4090/4080/4070/L4/L40
        ...
        - GPU: RTX 4090, RTX 4080, RTX 4070, L4, L40, or other SM89 GPUs
