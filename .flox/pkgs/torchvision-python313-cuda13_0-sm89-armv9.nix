# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA RTX 4090/L40 (SM89) + ARMv9
# Package name: torchvision-python313-cuda13_0-sm89-armv9
#
...
let
  ...
  # GPU target: SM89 (Blackwell Thor/NVIDIA DRIVE - automotive/edge computing)
  gpuArchSM = "8.9";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm89-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm89-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (DRIVE Thor: SM89)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA RTX 4090/L40 (SM89) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Blackwell Thor/DRIVE architecture (SM89)
