# TorchVision with PyTorch 2.10.0 for CPU-only + AVX-512 BF16
...
# No GPU/CUDA support - pure CPU inference and training with BF16 acceleration.
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-cpu-avx512bf16";
    patches = [];
    ninjaFlags = [ "-j32" ];
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    '';
    meta = oldAttrs.meta // {
      description = "TorchVision CPU-only + AVX-512 BF16 with PyTorch 2.10.0";
      longDescription = ''
