# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Hopper (SM90: H100/H200) + AVX2
# Package name: torchvision-python313-cuda13_0-sm90-avx2
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm90-avx2";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm90-avx2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA H100/H200 (SM90, Hopper) + AVX2 with PyTorch 2.10.0";
      longDescription = ''
