# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Blackwell (SM120: RTX 5090) + AVX-512 VNNI
# Package name: torchvision-python313-cuda13_0-sm120-avx512vnni
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm120-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm120-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA RTX 5090 (SM120, Blackwell) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
