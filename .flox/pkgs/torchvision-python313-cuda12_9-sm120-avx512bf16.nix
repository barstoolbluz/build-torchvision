# TorchVision optimized for NVIDIA Next-Gen (SM120) + AVX-512 BF16
# Package name: torchvision-python313-cuda12_9-sm120-avx512bf16
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm120-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Next-Gen (SM120) + AVX-512 BF16";
