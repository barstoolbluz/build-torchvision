# TorchVision optimized for NVIDIA Hopper H100/L40S (SM90) + AVX-512 VNNI
# Package name: torchvision-python313-cuda12_8-sm90-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_8-sm90-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Hopper H100/L40S (SM90) + AVX-512 VNNI";
