# TorchVision optimized for NVIDIA Hopper H100/H200 (SM90) + ARMv9
# Package name: torchvision-python313-cuda12_9-sm90-armv9
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm90-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Hopper H100/H200 (SM90) + ARMv9";
