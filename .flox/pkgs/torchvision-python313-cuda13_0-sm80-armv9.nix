# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA A100 (Ampere) (SM80) + ARMv9
# Package name: torchvision-python313-cuda13_0-sm80-armv9
#
...
let
  ...
  # GPU target: SM80 (Blackwell Thor/NVIDIA DRIVE - automotive/edge computing)
  gpuArchSM = "8.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm80-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm80-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (A100 (Ampere): SM80)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA A100 (Ampere) (SM80) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Blackwell Thor/DRIVE architecture (SM80)
