# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA DRIVE Thor (SM110) + ARMv9
# Package name: torchvision-python313-cuda13_1-sm110-armv9
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm110-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm110-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA DRIVE Thor (SM110) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
