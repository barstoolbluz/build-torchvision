# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) + AVX-512 BF16
# Package name: torchvision-python313-cuda13_1-sm75-avx512bf16
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm75-avx512bf16";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm75-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA T4/RTX 2080 Ti (SM75, Turing) + AVX-512 BF16 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Turing architecture (SM75) - T4, RTX 2080 Ti, Quadro RTX 8000
        - CPU: x86-64 with AVX-512 BF16 instruction set
        - CUDA: 13.1 with compute capability 7.5
