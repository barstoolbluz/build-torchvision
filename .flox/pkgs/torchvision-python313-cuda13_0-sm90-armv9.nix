# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA H100 (Hopper) (SM90) + ARMv9
# Package name: torchvision-python313-cuda13_0-sm90-armv9
#
...
let
  ...
  # GPU target: SM90 (Blackwell Thor/NVIDIA DRIVE - automotive/edge computing)
  gpuArchSM = "9.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm90-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_0-sm90-armv9";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (H100 (Hopper): SM90)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA H100 (Hopper) (SM90) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Blackwell Thor/DRIVE architecture (SM90)
