# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA RTX 3090/A40 (SM86) + ARMv8.2
# Package name: torchvision-python313-cuda13_1-sm86-armv8_2
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm86-armv8_2";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm86-armv8_2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA RTX 3090/A40 (SM86) + ARMv8.2 with PyTorch 2.10.0";
      longDescription = ''
