# TorchVision 0.24+ with PyTorch 2.10.0 for NVIDIA DGX Spark (SM121) + ARMv8.2
# Package name: torchvision-python313-cuda13_1-sm121-armv8_2
#
...
let
  ...
  # GPU target: SM121 (Blackwell DGX Spark - workstation/edge AI)
  gpuArchSM = "12.1";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchvision-sm121-armv8_2";
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda13_1-sm121-armv8_2";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (DGX Spark: SM121)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision for NVIDIA DGX Spark (SM121) + ARMv8.2 with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchVision build with targeted optimizations:
        - GPU: NVIDIA Blackwell DGX Spark architecture (SM121)
        ...
        - GPU: NVIDIA DGX Spark workstations
        - CPU: ARM Neoverse N1, Cortex-A75+, Grace CPU
