# TorchVision optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + ARMv9
# Package name: torchvision-python313-cuda12_9-sm89-armv9
...
in
  (nixpkgs_pinned.python3Packages.torchvision.override {
    ...
    pname = "torchvision-python313-cuda12_9-sm89-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchVision optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + ARMv9";
